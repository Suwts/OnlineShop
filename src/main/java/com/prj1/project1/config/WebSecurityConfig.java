package com.prj1.project1.config;

import com.prj1.project1.service.UserDetailsServiceImpl;
...
//                .requestMatchers("/admin/orderList", "/admin/order", "/admin/accountInfo").hasAnyRole("ROLE_EMPLOYEE", "ROLE_MANAGER")
